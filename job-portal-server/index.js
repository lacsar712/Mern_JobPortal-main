...
const uri =
  ...
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal.hqdzpij.mongodb.net/?appName=Job-portal`;
...
async function run() {
  try {
    ...
    const db = client.db(process.env.MONGO_DB_NAME || "mernJobPortal");
